...
namespace mrc
{
    internal sealed class MiniRepl : Repl
    {
        ...
        private bool LastTwoLinesAreBlank(string text)
        {
            ...
            if (lines.Count >= 2 && string.IsNullOrEmpty(lines[lines.Count - 1]) &&
                string.IsNullOrEmpty(lines[lines.Count - 2]))
            {
                return true;
            }
